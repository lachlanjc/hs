...
url: 'https://hs.lachlanjc.vercel.app/synthesis/docs',
link: '/docs'
}
...
_Listen to [“Lovely Day” by alt-J](https://youtu.be/HGP93-5N72I)._
...
<div className="footnote footnote--short"><h4>P.S.</h4><p>Check out <a href="https://hackclub.com">Hack Club</a>.</p></div>
...
In an English curriculum like AP Lit, you’ll likely find some representation. For example, [reading _Moby Dick_](https://lachlanjc.me/hs/moby-dick/), Ishmael and Queequeg have a little bromance featured on the side throughout the story. Here’s when they first meet, in an inn.
...
_Listen to [“Heaven’s Only Wishful” by MorMor](https://youtu.be/9PvIIn6cc1M)._
